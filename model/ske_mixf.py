...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=17, num_person=2, graph=None, graph_args=dict(), in_channels=3):
        ...
        self.l1 = Ske_MixF(80, 80, A, 300, residual=False)
        self.l2 = Ske_MixF(80, 80, A, 300)
        self.l3 = Ske_MixF(80, 80, A, 300)
        self.l4 = Ske_MixF(80, 80, A, 300)
        self.l5 = Ske_MixF(80, 160, A, 150, stride=2)
        self.l6 = Ske_MixF(160, 160, A, 150)
        self.l7 = Ske_MixF(160, 160, A, 150)
        self.l8 = Ske_MixF(160, 320, A, 75, stride=2)
        self.l9 = Ske_MixF(320, 320, A, 75)
        self.l10= Ske_MixF(320, 320, A, 75)
